...
GOIMPORTS_CMD = $(TEMPDIR)/gosimports -local github.com/khulnasoft-labs
...
bootstrap-tools: $(TEMPDIR)
	...
	curl -sSfL https://raw.githubusercontent.com/sulaiman-coder/gobouncer/master/bouncer.sh | sh -s -- -b $(TEMPDIR)/ $(BOUNCER_VERSION)
